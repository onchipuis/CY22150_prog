...
int CLKOE_LCLK3 =       0;       // 1/0 Activate (LCLK3)
int CLKOE_LCLK2 =       0;       // 1/0 Activate (LCLK2)
...
int CLKSRC_LCLK2 =      0;       // 3-bit Crosspoint switch matrix control (LCLK2)
int CLKSRC_LCLK3 =      0;       // 3-bit Crosspoint switch matrix control (LCLK3)
